...
export default async function SiteSettingsPage({ params: { locale } }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">{t('siteSettings')}</h1>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 min-w-0">
          <SiteSettingsForm locale={locale} />
        </div>
      </div>
    </div>
  );
